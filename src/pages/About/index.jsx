      ...
      <Row className={`${styles.fullWidthBackground} justify-content-center`}>
        <Col md={8} className={`${styles.fullWidthText} text-center`}>
          ...
          <p className={styles.subHeader}>
            Please fill the form and we will guide you to the best solution. Our{" "}
            <br /> experts will get in touch soon.
          </p>
        </Col>
      </Row>
      <Container fluid>
        <section className={`${styles.descriptionSection} `}>
          <div className={styles.caresrs}>
            <div className={styles.caresrs1}>
              ...
              is a prominent Egyptian job search and recruitment platform
              designed to connect job seekers with employers across various
              industries in Egypt.{" "}
            </div>

            <div className={styles.caresrs1}>
              The platform provides an intuitive interface for job seekers to
              search for jobs and for employers to post job advertisements.
            </div>

            <div className={styles.caresrs1}>
              Key features include detailed personal profiles, resume uploads,
              and the ability to make profiles public or private to enhance
